...
ENGLISH_UI = {
    ...
    "UI_CALLOUT_TEXT": "The published skills work independently after installation. The engineering harness and its research material stay inside this repository and are never required by an end user.",
    ...
    "UI_BOUNDARY_EYEBROW": "The boundary", "UI_BOUNDARY_TITLE": "No harness knowledge required.",
    "UI_BOUNDARY_TEXT": "The harness is for project development and validation. People using the published skills only need the installed skill and the agent where it was added.",
    ...
    "UI_CATALOG_EYEBROW": "The collection", "UI_CATALOG_TITLE": "Skills with a job to do.",
    "UI_CATALOG_LEDE": "Each page explains when a skill fits, what it does, how it works, and where its responsibility stops.",
    "UI_SKILLS_IN_COLLECTION": "skills in the collection",
    "UI_CATALOG_INTRO": "The catalog follows a practical path: discover the environment, install and run OpenVINO, then optimize or serve the workload.",
    "UI_CARD_EXPLORE": "Explore skill", "UI_CARD_READ_DETAILS": "Read details",
    "UI_BACK_TO_CATALOG": "Back to catalog", "UI_WHAT_IT_IS": "What it is",
    "UI_SKILL_H2_SUFFIX": "in practice", "UI_USE_IT_WHEN": "Use it when",
    "UI_WORKFLOW": "Workflow", "UI_BOUNDARY": "Boundaries",
